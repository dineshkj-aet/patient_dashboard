...
{/* PAGINATION CONTROLS */}
      ...
      <span style={{ fontSize: "14px", color: "#475569" }}>
        ...
        <div style={{ display: "flex", alignItems: "right", gap: "8px" }}>
        <span style={{ fontSize: "14px", color: "#475569" }}>  Page size</span>
          <input
                placeholder={`${limit}`}
                value={`${tempLimit}`}
                ...
                style={{ maxWidth: "35px", ...inputStyle }}
              />
        </div>
    ...
    >
      ...
      {formErrors.length > 0 && (
        ...
        <ul style={{ margin: 0, paddingLeft: "20px" }}>
            {formErrors.map((err) => (
              <li key={err} style={{ marginBottom: "2px",textAlign:"left" }}>
                {err}
              </li>
            ))}
          </ul>
